...
export const T = {
  ru: {
    ...
    'nav.stats': 'Статистика', 'nav.settings': 'Настройки', 'nav.create': 'Создать',
    ...
    'due.label': 'Дедлайн', 'due.none': 'не задан', 'due.clear': 'Убрать дедлайн', 'due.remind_at': 'Напомнить',
    'due.overdue': 'просрочено', 'due.today': 'сегодня', 'due.tomorrow': 'завтра', 'due.in_days': 'через {n} дн.',
    'due.date': 'Дата', 'due.time': 'Время',
    ...
    'notif.title': 'Уведомления', 'notif.empty': 'Дедлайнов и напоминаний пока нет.', 'notif.mark_seen': 'Прочитано',
    'notif.overdue': 'Просрочена', 'notif.soon': 'Скоро дедлайн', 'notif.reminder': 'Напоминание',
    'notif.enable': 'Напоминания о дедлайнах', 'notif.system': 'Уведомления в системе',
    'notif.perm_granted': 'разрешены', 'notif.perm_denied': 'запрещены', 'notif.perm_ask': 'разрешить',
    ...
    'sync.toggle_label': 'Синхронизация',
  ...
  en: {
    ...
    'nav.stats': 'Stats', 'nav.settings': 'Settings', 'nav.create': 'Create',
    ...
    'due.label': 'Deadline', 'due.none': 'not set', 'due.clear': 'Clear deadline', 'due.remind_at': 'Remind',
    'due.overdue': 'overdue', 'due.today': 'today', 'due.tomorrow': 'tomorrow', 'due.in_days': 'in {n} d',
    'due.date': 'Date', 'due.time': 'Time',
    'remind.none': 'No reminder', 'remind.at': 'At the deadline', 'remind.15m': '15 minutes before',
    'remind.1h': 'An hour before', 'remind.3h': '3 hours before', 'remind.1d': 'A day before', 'remind.custom': 'Custom time',
    'notif.title': 'Notifications', 'notif.empty': 'No deadlines or reminders yet.', 'notif.mark_seen': 'Mark read',
    'notif.overdue': 'Overdue', 'notif.soon': 'Due soon', 'notif.reminder': 'Reminder',
    'notif.enable': 'Deadline reminders', 'notif.system': 'System notifications',
    'notif.perm_granted': 'allowed', 'notif.perm_denied': 'blocked', 'notif.perm_ask': 'allow',
  ...
  uk: {
    ...
    'nav.stats': 'Статистика', 'nav.settings': 'Налаштування', 'nav.create': 'Створити',
    ...
    'due.label': 'Дедлайн', 'due.none': 'не задано', 'due.clear': 'Прибрати дедлайн', 'due.remind_at': 'Нагадати',
    'due.overdue': 'протерміновано', 'due.today': 'сьогодні', 'due.tomorrow': 'завтра', 'due.in_days': 'через {n} дн.',
    'due.date': 'Дата', 'due.time': 'Час',
    'remind.none': 'Без нагадування', 'remind.at': 'У момент дедлайну', 'remind.15m': 'За 15 хвилин',
    'remind.1h': 'За годину', 'remind.3h': 'За 3 години', 'remind.1d': 'За день', 'remind.custom': 'Свій час',
    'notif.title': 'Сповіщення', 'notif.empty': 'Дедлайнів і нагадувань поки немає.', 'notif.mark_seen': 'Прочитано',
    'notif.overdue': 'Протерміновано', 'notif.soon': 'Скоро дедлайн', 'notif.reminder': 'Нагадування',
    'notif.enable': 'Нагадування про дедлайни', 'notif.system': 'Сповіщення в системі',
    'notif.perm_granted': 'дозволено', 'notif.perm_denied': 'заборонено', 'notif.perm_ask': 'дозволити',
    ...
    'sync.toggle_label': 'Синхронізація',
  ...
  kk: {
    ...
    'nav.stats': 'Статистика', 'nav.settings': 'Баптаулар', 'nav.create': 'Құру',
    ...
    'due.label': 'Дедлайн', 'due.none': 'қойылмаған', 'due.clear': 'Дедлайнды алып тастау', 'due.remind_at': 'Еске салу',
    'due.overdue': 'мерзімі өтті', 'due.today': 'бүгін', 'due.tomorrow': 'ертең', 'due.in_days': '{n} күнде',
    'due.date': 'Күні', 'due.time': 'Уақыты',
    'remind.none': 'Еске салусыз', 'remind.at': 'Дедлайн сәтінде', 'remind.15m': '15 минут бұрын',
    'remind.1h': 'Бір сағат бұрын', 'remind.3h': '3 сағат бұрын', 'remind.1d': 'Бір күн бұрын', 'remind.custom': 'Өз уақыты',
    'notif.title': 'Хабарламалар', 'notif.empty': 'Дедлайндар мен еске салулар жоқ.', 'notif.mark_seen': 'Оқылды',
    'notif.overdue': 'Мерзімі өтті', 'notif.soon': 'Дедлайн жақын', 'notif.reminder': 'Еске салу',
    'notif.enable': 'Дедлайн еске салулары', 'notif.system': 'Жүйедегі хабарламалар',
    'notif.perm_granted': 'рұқсат етілген', 'notif.perm_denied': 'тыйым салынған', 'notif.perm_ask': 'рұқсат беру',
