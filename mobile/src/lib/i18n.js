...
export const T = {
  ru: {
    ...
    'export.all_excel': 'Общий экспорт в Excel', 'export.pick_period': 'Выбрать период экспорта',
  ...
  en: {
    ...
    'export.all_excel': 'Export all to Excel', 'export.pick_period': 'Choose export period',
  ...
  uk: {
    ...
    'export.all_excel': 'Загальний експорт в Excel', 'export.pick_period': 'Обрати період експорту',
  ...
  kk: {
    ...
    'export.all_excel': 'Excel-ге жалпы экспорт', 'export.pick_period': 'Экспорт кезеңін таңдау',
