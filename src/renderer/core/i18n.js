...
(function (global) {
  ...
  const T = {
    ...
    en: {
      ...
      'settings.section_main': 'General', 'settings.section_data': 'Data', 'settings.section_work': 'Work', 'settings.section_about': 'About', 'settings.section_statuses': 'Task statuses', 'settings.section_tags': 'Tags', 'status.default_backlog': 'Backlog', 'status.default_todo': 'To do', 'status.default_progress': 'In progress', 'status.default_checking': 'Checking', 'status.default_done': 'Done', 'status.default_cancelled': 'Cancelled', 'status.kind_backlog': 'Backlog', 'status.kind_todo': 'Planned', 'status.kind_progress': 'In progress', 'status.kind_done': 'Completed', 'status.kind_cancelled': 'Cancelled', 'status.add': 'New status', 'status.builtin_hint': 'A built-in status can be renamed and recoloured, but not deleted', 'tag.add': 'New tag', 'tag.none': 'No tags yet', 'tag.pick': 'Tags', 'tag.dialog_new': 'New tag', 'tag.dialog_edit': 'Tag', 'tag.name_ph': 'Tag name', 'tag.search_ph': 'Find or create', 'tag.create_named': 'Create tag “{name}”', 'tag.name_taken': 'A tag with this name already exists', 'tag.unused': 'not used', 'tag.used_projects': 'projects: {n}', 'tag.used_tasks': 'tasks: {n}', 'tag.delete_confirm': 'Delete the tag “{name}”?', 'tag.delete_used': 'The tag “{name}” is in use ({n}). It will be removed from everything and deleted. Continue?', 'tag.empty_hint': 'Tags are shared across the whole app: one tag can sit on a project and on a task in any other project.', 'version.none': 'No version', 'version.add': 'New version', 'repeat.label': 'Repeat', 'repeat.freq_year': 'Year', 'repeat.none': 'Does not repeat', 'repeat.daily': 'Every day', 'repeat.weekly': 'Every week', 'repeat.monthly': 'Every month', 'repeat.yearly': 'Every year', 'repeat.weekdays_preset': 'Weekdays, Mon–Fri', 'repeat.custom': 'Custom…', 'repeat.dialog_title': 'Task repeat', 'repeat.every': 'Repeat every', 'repeat.unit_day': 'd', 'repeat.unit_week': 'wk', 'repeat.unit_month': 'mo', 'repeat.unit_year': 'yr', 'repeat.on_days': 'On days', 'repeat.month_mode_day': 'By day of month', 'repeat.month_mode_weekday': 'By day of week', 'repeat.from_label': 'Count from', 'repeat.from_schedule': 'The schedule', 'repeat.from_done': 'The day it is closed', 'repeat.keep_history': 'Keep completed copies', 'repeat.keep_history_hint': 'Each time a finished task stays in the list with its own time', 'repeat.ends_label': 'Ends', 'repeat.ends_never': 'Never', 'repeat.ends_after': 'After', 'repeat.ends_times': 'times', 'repeat.ends_on': 'On date', 'repeat.desc_day': 'every day', 'repeat.desc_day_n': 'every {n} d', 'repeat.desc_week': 'every week', 'repeat.desc_week_n': 'every {n} wk', 'repeat.desc_month': 'every month', 'repeat.desc_month_n': 'every {n} mo', 'repeat.desc_year': 'every year', 'repeat.desc_year_n': 'every {n} yr', 'repeat.desc_week_days': 'on {days}', 'repeat.desc_week_days_n': 'every {n} wk, on {days}', 'repeat.next': 'next time {date}', 'repeat.series_done': 'The repeat has ended', 'repeat.moved': 'Next due: {date}', 'repeat.needs_due': 'A repeat counts from the deadline — set one first', 'agenda.days4': '4 days', 'agenda.schedule': 'Schedule', 'agenda.calendars': 'My projects', 'agenda.all_day': 'All day', 'agenda.new_entry': 'New entry', 'agenda.create_title': 'Create task', 'agenda.task_name_ph': 'Task name', 'agenda.create_btn': 'Create', 'agenda.or_existing': 'Or add the time to a task', 'agenda.no_projects': 'Create a project first', 'agenda.empty': 'No entries for this period', 'agenda.deadline': 'Deadline', 'agenda.now': 'Now', 'agenda.open_task': 'Open task', 'agenda.delete_entry': 'Delete entry', 'version.all': 'All versions', 'version.filter_reset': 'Reset', 'stats.by_version': 'By version', 'filter.project': 'Project', 'filter.all_projects': 'All projects', 'xlsx.version': 'Version', 'status.section': 'Statuses', 'version.section': 'Versions', 'version.label': 'Version', 'version.manage': 'Manage versions…', 'version.name_ph': 'Version name', 'version.in_progress': 'in progress', 'version.released_on': 'released {date}', 'version.mark_released': 'Mark as released…', 'version.mark_open': 'Move back to in progress', 'version.tasks_n': 'tasks: {n}', 'version.name_taken': 'A version with this name already exists in the project', 'version.delete_confirm': 'Delete the version “{name}”?', 'version.delete_used': 'The version “{name}” has tasks ({n}). The tasks stay, but the version comes off them. Continue?', 'version.empty_hint': 'Versions belong to one project. A task has a single version, and on the board versions become swimlanes.', 'version.lane_toggle': 'Collapse or expand the lane', 'nav.board': 'Board', 'board.add_task': 'Add task', 'board.statuses': 'Statuses and versions', 'board.pick_project': 'Pick a project', 'status.dialog_title': 'Project setup', 'status.name_ph': 'Name', 'status.delete_last_done': 'This is the last status that completes a task, so it cannot be deleted', 'status.delete_last': 'At least one status has to remain', 'status.move_tasks': 'Tasks in this status will move to “{name}”. Continue?', 'task.status_label': 'Status', 'stats.by_status': 'By status', 'board.empty': 'Create a project first.', 'about.us': 'About us', 'about.blog': 'Blog',
    ...
    uk: {
      ...
      'settings.section_main': 'Основне', 'settings.section_data': 'Дані', 'settings.section_work': 'Робота', 'settings.section_about': 'Про застосунок', 'settings.section_statuses': 'Статуси завдань', 'settings.section_tags': 'Теги', 'status.default_backlog': 'Backlog', 'status.default_todo': 'To do', 'status.default_progress': 'In progress', 'status.default_checking': 'Checking', 'status.default_done': 'Done', 'status.default_cancelled': 'Cancelled', 'status.kind_backlog': 'Склад ідей', 'status.kind_todo': 'Заплановано', 'status.kind_progress': 'У роботі', 'status.kind_done': 'Зроблено', 'status.kind_cancelled': 'Скасовано', 'status.add': 'Новий статус', 'status.builtin_hint': 'Вбудований статус можна перейменувати та перефарбувати, але не видалити', 'tag.add': 'Новий тег', 'tag.none': 'Тегів поки немає', 'tag.pick': 'Теги', 'tag.dialog_new': 'Новий тег', 'tag.dialog_edit': 'Тег', 'tag.name_ph': 'Назва тега', 'tag.search_ph': 'Знайти або створити', 'tag.create_named': 'Створити тег «{name}»', 'tag.name_taken': 'Тег із такою назвою вже є', 'tag.unused': 'не використовується', 'tag.used_projects': 'проектів: {n}', 'tag.used_tasks': 'завдань: {n}', 'tag.delete_confirm': 'Видалити тег «{name}»?', 'tag.delete_used': 'Тег «{name}» використовується ({n}). Його буде знято з усього і видалено. Продовжити?', 'tag.empty_hint': 'Теги спільні для всього застосунку: один тег можна повісити і на проект, і на завдання в будь-якому іншому проекті.', 'version.none': 'Без версії', 'version.add': 'Нова версія', 'repeat.label': 'Повторення', 'repeat.freq_year': 'Рік', 'repeat.none': 'Не повторюється', 'repeat.daily': 'Щодня', 'repeat.weekly': 'Щотижня', 'repeat.monthly': 'Щомісяця', 'repeat.yearly': 'Щороку', 'repeat.weekdays_preset': 'У будні, Пн–Пт', 'repeat.custom': 'Налаштувати…', 'repeat.dialog_title': 'Повторення завдання', 'repeat.every': 'Повторювати кожні', 'repeat.unit_day': 'дн.', 'repeat.unit_week': 'тижн.', 'repeat.unit_month': 'міс.', 'repeat.unit_year': 'р.', 'repeat.on_days': 'У дні', 'repeat.month_mode_day': 'За числом місяця', 'repeat.month_mode_weekday': 'За днем тижня', 'repeat.from_label': 'Відлік', 'repeat.from_schedule': 'За розкладом', 'repeat.from_done': 'Від дня закриття', 'repeat.keep_history': 'Залишати виконані копії', 'repeat.keep_history_hint': 'Щоразу в списку залишиться завершене завдання зі своїм часом', 'repeat.ends_label': 'Завершення', 'repeat.ends_never': 'Ніколи', 'repeat.ends_after': 'Після', 'repeat.ends_times': 'разів', 'repeat.ends_on': 'До дати', 'repeat.desc_day': 'щодня', 'repeat.desc_day_n': 'кожні {n} дн.', 'repeat.desc_week': 'щотижня', 'repeat.desc_week_n': 'кожні {n} тижн.', 'repeat.desc_month': 'щомісяця', 'repeat.desc_month_n': 'кожні {n} міс.', 'repeat.desc_year': 'щороку', 'repeat.desc_year_n': 'кожні {n} р.', 'repeat.desc_week_days': 'у {days}', 'repeat.desc_week_days_n': 'кожні {n} тижн., у {days}', 'repeat.next': 'наступного разу {date}', 'repeat.series_done': 'Повторення завершилося', 'repeat.moved': 'Наступний строк: {date}', 'repeat.needs_due': 'Повторення рахується від дедлайну — спершу поставте його', 'agenda.days4': '4 дні', 'agenda.schedule': 'Розклад', 'agenda.calendars': 'Мої проекти', 'agenda.all_day': 'Увесь день', 'agenda.new_entry': 'Новий запис', 'agenda.create_title': 'Створити завдання', 'agenda.task_name_ph': 'Назва завдання', 'agenda.create_btn': 'Створити', 'agenda.or_existing': 'Або додати час до завдання', 'agenda.no_projects': 'Спочатку потрібен проект', 'agenda.empty': 'За цей період записів немає', 'agenda.deadline': 'Дедлайн', 'agenda.now': 'Зараз', 'agenda.open_task': 'Відкрити завдання', 'agenda.delete_entry': 'Видалити запис', 'version.all': 'Усі версії', 'version.filter_reset': 'Скинути', 'stats.by_version': 'За версіями', 'filter.project': 'Проект', 'filter.all_projects': 'Усі проекти', 'xlsx.version': 'Версія', 'status.section': 'Статуси', 'version.section': 'Версії', 'version.label': 'Версія', 'version.manage': 'Налаштувати версії…', 'version.name_ph': 'Назва версії', 'version.in_progress': 'у роботі', 'version.released_on': 'випущена {date}', 'version.mark_released': 'Позначити випущеною…', 'version.mark_open': 'Повернути в роботу', 'version.tasks_n': 'завдань: {n}', 'version.name_taken': 'Версія з такою назвою вже є в проекті', 'version.delete_confirm': 'Видалити версію «{name}»?', 'version.delete_used': 'У версії «{name}» є завдання ({n}). Завдання залишаться, але версію з них буде знято. Продовжити?', 'version.empty_hint': 'Версії свої в кожного проекту. У завдання версія одна, а на дошці версії показуються доріжками.', 'version.lane_toggle': 'Згорнути або розгорнути доріжку', 'nav.board': 'Дошка', 'board.add_task': 'Додати завдання', 'board.statuses': 'Статуси та версії', 'board.pick_project': 'Вибрати проект', 'status.dialog_title': 'Налаштування проекту', 'status.name_ph': 'Назва', 'status.delete_last_done': 'Це останній статус, що завершує завдання — його не можна видалити', 'status.delete_last': 'Має залишитися щонайменше один статус', 'status.move_tasks': 'Завдання з цього статусу перейдуть до «{name}». Продовжити?', 'task.status_label': 'Статус', 'stats.by_status': 'За статусами', 'board.empty': 'Спочатку створіть проект.', 'about.us': 'Про нас', 'about.blog': 'Блог',
      'settings.theme_label': 'Тема', 'settings.currency_label': 'Валюта',
    ...
    kk: {
      ...
      'settings.section_main': 'Негізгі', 'settings.section_data': 'Деректер', 'settings.section_work': 'Жұмыс', 'settings.section_about': 'Қосымша туралы', 'settings.section_statuses': 'Тапсырма күйлері', 'settings.section_tags': 'Тегтер', 'status.default_backlog': 'Backlog', 'status.default_todo': 'To do', 'status.default_progress': 'In progress', 'status.default_checking': 'Checking', 'status.default_done': 'Done', 'status.default_cancelled': 'Cancelled', 'status.kind_backlog': 'Идеялар қоймасы', 'status.kind_todo': 'Жоспарланған', 'status.kind_progress': 'Жұмыста', 'status.kind_done': 'Орындалды', 'status.kind_cancelled': 'Болдырылды', 'status.add': 'Жаңа күй', 'status.builtin_hint': 'Кіріктірілген күйді атын өзгертуге және бояуға болады, бірақ жоюға болмайды', 'tag.add': 'Жаңа тег', 'tag.none': 'Тегтер әлі жоқ', 'tag.pick': 'Тегтер', 'tag.dialog_new': 'Жаңа тег', 'tag.dialog_edit': 'Тег', 'tag.name_ph': 'Тег атауы', 'tag.search_ph': 'Табу немесе құру', 'tag.create_named': '«{name}» тегін құру', 'tag.name_taken': 'Мұндай атаулы тег бар', 'tag.unused': 'қолданылмайды', 'tag.used_projects': 'жобалар: {n}', 'tag.used_tasks': 'тапсырмалар: {n}', 'tag.delete_confirm': '«{name}» тегін жою керек пе?', 'tag.delete_used': '«{name}» тегі қолданыста ({n}). Ол барлық жерден алынып, жойылады. Жалғастыру керек пе?', 'tag.empty_hint': 'Тегтер бүкіл қосымшаға ортақ: бір тегті жобаға да, кез келген басқа жобадағы тапсырмаға да қоюға болады.', 'version.none': 'Нұсқасыз', 'version.add': 'Жаңа нұсқа', 'repeat.label': 'Қайталау', 'repeat.freq_year': 'Жыл', 'repeat.none': 'Қайталанбайды', 'repeat.daily': 'Күн сайын', 'repeat.weekly': 'Апта сайын', 'repeat.monthly': 'Ай сайын', 'repeat.yearly': 'Жыл сайын', 'repeat.weekdays_preset': 'Жұмыс күндері, Дс–Жм', 'repeat.custom': 'Баптау…', 'repeat.dialog_title': 'Тапсырманы қайталау', 'repeat.every': 'Әр', 'repeat.unit_day': 'күн', 'repeat.unit_week': 'апта', 'repeat.unit_month': 'ай', 'repeat.unit_year': 'жыл', 'repeat.on_days': 'Күндері', 'repeat.month_mode_day': 'Айдың күні бойынша', 'repeat.month_mode_weekday': 'Апта күні бойынша', 'repeat.from_label': 'Санау', 'repeat.from_schedule': 'Кесте бойынша', 'repeat.from_done': 'Жабылған күннен', 'repeat.keep_history': 'Орындалған көшірмелерді қалдыру', 'repeat.keep_history_hint': 'Әр жолы тізімде өз уақытымен аяқталған тапсырма қалады', 'repeat.ends_label': 'Аяқталу', 'repeat.ends_never': 'Ешқашан', 'repeat.ends_after': 'Кейін', 'repeat.ends_times': 'рет', 'repeat.ends_on': 'Күнге дейін', 'repeat.desc_day': 'күн сайын', 'repeat.desc_day_n': 'әр {n} күн', 'repeat.desc_week': 'апта сайын', 'repeat.desc_week_n': 'әр {n} апта', 'repeat.desc_month': 'ай сайын', 'repeat.desc_month_n': 'әр {n} ай', 'repeat.desc_year': 'жыл сайын', 'repeat.desc_year_n': 'әр {n} жыл', 'repeat.desc_week_days': '{days} күндері', 'repeat.desc_week_days_n': 'әр {n} апта, {days} күндері', 'repeat.next': 'келесі рет {date}', 'repeat.series_done': 'Қайталау аяқталды', 'repeat.moved': 'Келесі мерзім: {date}', 'repeat.needs_due': 'Қайталау мерзімнен саналады — алдымен оны қойыңыз', 'agenda.days4': '4 күн', 'agenda.schedule': 'Кесте', 'agenda.calendars': 'Менің жобаларым', 'agenda.all_day': 'Күні бойы', 'agenda.new_entry': 'Жаңа жазба', 'agenda.create_title': 'Тапсырма құру', 'agenda.task_name_ph': 'Тапсырма атауы', 'agenda.create_btn': 'Құру', 'agenda.or_existing': 'Немесе уақытты тапсырмаға қосу', 'agenda.no_projects': 'Алдымен жоба керек', 'agenda.empty': 'Бұл кезеңде жазбалар жоқ', 'agenda.deadline': 'Мерзім', 'agenda.now': 'Қазір', 'agenda.open_task': 'Тапсырманы ашу', 'agenda.delete_entry': 'Жазбаны жою', 'version.all': 'Барлық нұсқалар', 'version.filter_reset': 'Тазалау', 'stats.by_version': 'Нұсқалар бойынша', 'filter.project': 'Жоба', 'filter.all_projects': 'Барлық жобалар', 'xlsx.version': 'Нұсқа', 'status.section': 'Күйлер', 'version.section': 'Нұсқалар', 'version.label': 'Нұсқа', 'version.manage': 'Нұсқаларды баптау…', 'version.name_ph': 'Нұсқа атауы', 'version.in_progress': 'жұмыста', 'version.released_on': '{date} шыққан', 'version.mark_released': 'Шығарылды деп белгілеу…', 'version.mark_open': 'Жұмысқа қайтару', 'version.tasks_n': 'тапсырмалар: {n}', 'version.name_taken': 'Жобада мұндай атаулы нұсқа бар', 'version.delete_confirm': '«{name}» нұсқасын жою керек пе?', 'version.delete_used': '«{name}» нұсқасында тапсырмалар бар ({n}). Тапсырмалар қалады, бірақ нұсқа олардан алынады. Жалғастыру керек пе?', 'version.empty_hint': 'Нұсқалар әр жобада өз алдына. Тапсырманың нұсқасы біреу, ал тақтада нұсқалар жолақтармен көрсетіледі.', 'version.lane_toggle': 'Жолақты жию немесе жаю', 'nav.board': 'Тақта', 'board.add_task': 'Тапсырма қосу', 'board.statuses': 'Күйлер мен нұсқалар', 'board.pick_project': 'Жоба таңдау', 'status.dialog_title': 'Жоба баптаулары', 'status.name_ph': 'Атауы', 'status.delete_last_done': 'Бұл — тапсырманы аяқтайтын соңғы күй, оны жоюға болмайды', 'status.delete_last': 'Кемінде бір күй қалуы керек', 'status.move_tasks': 'Бұл күйдегі тапсырмалар «{name}» күйіне көшеді. Жалғастыру керек пе?', 'task.status_label': 'Күй', 'stats.by_status': 'Күйлер бойынша', 'board.empty': 'Алдымен жоба құрыңыз.', 'about.us': 'Біз туралы', 'about.blog': 'Блог',
